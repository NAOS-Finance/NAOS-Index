...
import {getOrDeployUSDC18} from "./baseDeploy/getOrDeployUSDC18"
...
const baseDeploy18: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  if (isMainnetForking()) {
    return
  }
  ...
  await getOrDeployUSDC18(deployer, config)
